...
if (!class_exists('ElfsightWeatherPlugin')) {
    class ElfsightWeatherPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightWeatherPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightWeatherWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightWeatherPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightWeatherWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightWeatherVCElement($config, $this->widgetsApi);
